...
namespace LoginCrud.Controllers
{
    ...
    public class OfficesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Designation,Salary")] Office office)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Designation,Salary")] Office office)
        {
            if (ModelState.IsValid)
            {
